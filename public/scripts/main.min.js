...
'use strict';module.exports=function(a){function c(){'/'===window.location.pathname?(d.classList.remove('compact'),e.classList.remove('compact')):(d.classList.add('compact'),e.classList.add('compact'))}var d=document.querySelector('.logo'),e=document.querySelector('.content');document.addEventListener('click',function(){c()}),c(),a()};
