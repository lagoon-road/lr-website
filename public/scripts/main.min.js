...
'use strict';var router=require('lr-client-router'),renderer=require('lr-client-renderer'),road=require('lr-core')('client');road.extension('router',router,!0).extension('renderer',renderer,!0).middleware({'events.navigation':require('../middleware/events/navigation')}),require('./road')(road);

},{"../middleware/events/navigation":31,"./road":6,"lr-client-renderer":1,"lr-client-router":2,"lr-core":3}],6:[function(require,module,exports){
